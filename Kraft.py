...
class Axiom1(Scene):
    def construct(self):
        ...
        self.play(iceblock.animate.move_to([8.5,-2.2,0]),t.animate.set_value(10),FadeIn(mark2), rate_func=linear, run_time=2.8)
        ...
        line.add_updater(lambda mob : mob.become(Line(2.6*LEFT, RIGHT*(t.get_value()-2.6))).shift(0.5*DOWN))
        self.play(iceblock.animate.move_to([8.5,-2.2,0]),t.animate.set_value(10),FadeIn(mark3), rate_func=linear, run_time=2.8)
        self.remove(vaddon,geschwindigkeit)
        self.wait(2)
        self.play(Circumscribe(axiom1textkurzgruppe))
        self.wait()
...
#KRAFT MESSEN UND DARSTELLEN SIND SCHON GESTRECHT
