...
class Inhaltsverzeichnes(Scene):
    def construct(self): 
        ...
        waskraft = Tex("Was ist Kraft?")
        kraftmessen = Tex("Wie misst man Kraft?")
        newton = Tex("Isaac Newtons Geschichte")
        kraftdarstellen = Tex("Kraft darstellen")
        kraftaufteilung = Tex("Kraftaufteilung")
        axiom2 = Tex("Newtons zweites Axiom")
        gewichtskraft = Tex("Gewichtskraft")
        axiom1 = Tex("Newtons erstes Axiom")
        addition = Tex("Kräfte addieren")
        kräfteparalellogramm = Tex("Kräfteparalellogramm")
        axiom3 = Tex("Newtons drittes Axiom")
        kräftegleichgewicht = Tex("Kräftegleichgewicht")
        fazit = Tex("Fazit")
...
class Kraftaufteilung(Scene):
    def construct(self):
        ...
        f1 = MathTex(r"\vec{F_{1}}")
        f2 = MathTex(r"\vec{F_{2}}")
        f3 = MathTex(r"\vec{F_{3}}")
        f4 = MathTex(r"\vec{F_{4}}")
        ...
        fformel = MathTex(r"\vec{F}_{Teilst \ddot{a} rke} = \frac{\vec{F}_{Gesamtst \ddot{a} rke}} {Teilanzahl}")
...
class Axiom2beispiele(Scene):
    def construct(self):
        ...
        #texte
        axiom2 = Tex("Newtons zweites Axiom - Beispiele").scale(1.2)
        ul1 = Underline(axiom2)
        ...
        self.wait(3)
        self.play(FadeIn(ice))
        sovielnewton2.add_updater(lambda mob : mob.next_to(v1,UP).shift(0.3*DL))
        self.play(FadeIn(v1,sovielnewton2),t.animate.set_value(1),rate_func=linear, run_time=1)
        self.play(t.animate.set_value(6), rate_func=linear, run_time=6)
        self.play(FadeOut(ice,sovielnewton2,v1))
        t.set_value(0)
        self.wait(1)
...
class Axiom1(Scene):
    def construct(self):
        ...
        #texte
        axiom1 = Tex("Newtons erstes Axiom").scale(1.2)
...
class Axiom3(Scene):
    def construct(self):
        ...
        text2kurz = Tex("Kraft = Gegenkraft")
        blackbox7 = SurroundingRectangle(text1kurz, buff=0, color=BLACK,fill_opacity=1)
        text2kurzgruppe = VGroup(blackbox7,text2kurz)
        text2kurz[0][0:5].set_color("#F5B176")
        text2kurz[0][6:17].set_color("#86CFF9")
        ...
        vergleich = MathTex(r"\vec{F_{1}} = \vec{F_{2}}").scale(0.8)
        newton1 = MathTex(r"\vec{F_{1}} \approx  200.000 N").scale(0.8)
        newton2 = MathTex(r"\vec{F_{2}} \approx  200.000 N").scale(0.8)
        ...
        self.wait(2)
        text2kurzgruppe.next_to(text1kurzgruppe, DOWN).to_edge(LEFT)
        self.play(Write(text2kurzgruppe))
        ...
        self.wait(5)
        vergleich.next_to(text2kurzgruppe, DOWN).to_edge(LEFT)
        self.play(Write(vergleich))
        self.wait(7)
        self.play(
...
class Ending(Scene):
    def construct(self):
        ...
        quellen = Tex("Quellen").scale(1.2)
        ul1 = Underline(quellen)
        quellengruppe = VGroup(quellen,ul1)
        tex1 = Text('- Arbeitsblatt: "KRÄFTE UND ZUSAMMENWIRKEN VON KRÄFTEN"').scale(0.6)
        tex2 = Text('- Waagenmodell passend zur Präsentation: https://www.experi').scale(0.6)
        tex2_1 = Text('mentis-shop.de/newton-und-kilogramm-federwaage-​').scale(0.6)
        tex2_2 = Text('detail-677.html?​').scale(0.6)
        tex3 = Text('- https://www.waagen-forum.de/index.php?title=Waage&utm').scale(0.6)
        tex4 = Text('- https://de.wikipedia.org/wiki/Gewichtskraft').scale(0.6)
        tex5 = Text('- https://de.wikipedia.org/wiki/Waage').scale(0.6)
        tex6 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-kraftarten/').scale(0.6)
        tex6_1 = Text('grundwissen/wirkungen-von-kraeften').scale(0.6)
        tex7 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-kraftarten/').scale(0.6)
        tex7_1 = Text('grundwissen/beschreibung-von-kraeften').scale(0.6)
        tex8 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-kraftarten/').scale(0.6)
        tex8_1 = Text('grundwissen/gleichgewicht-von-kraeften-einfuehrung').scale(0.6)
        tex9 = Text('- https://sailer-gymnasium.de/images/Faecher/Physik/').scale(0.6)
        tex9_1 = Text('Grundwissen/Ph_7_M2.pdf').scale(0.6)
        tex10 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-bewegungs').scale(0.6)
        tex10_1 = Text('aenderung/grundwissen/1-newtonsches-gesetz-traegheitsgesetz').scale(0.6)
        tex11 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-bewegungs').scale(0.6)
        tex11_1 = Text('aenderung/grundwissen/2-newtonsches-gesetz-aktionsprinzip').scale(0.6)
        tex12 = Text('- https://www.leifiphysik.de/mechanik/kraft-und-bewegungs').scale(0.6)
        tex12_1 = Text('aenderung/grundwissen/3-newtonsches-gesetz-wechsel').scale(0.6)
        tex12_2 = Text('wirkungsprinzip').scale(0.6)
        tex13 = Text('- https://studyflix.de/ingenieurwissenschaften/').scale(0.6)
        tex13_1 = Text('krafteparallelogramm-1501').scale(0.6)
        tex14 = Text('- https://studyflix.de/mathematik/vektor-2249').scale(0.6)
        tex15 = Text('- https://studyflix.de/mathematik/vektoren-addieren-und-').scale(0.6)
        tex15_1 = Text('subtrahieren-5654').scale(0.6)
        tex16 = Text('- https://de.wikipedia.org/wiki/Isaac_Newton').scale(0.6)
        tex17 = Text('- https://www.werwareigentlich.de/newton-isaac.shtml').scale(0.6)
        tex18 = Text('- https://www1.wdr.de/stichtag/stichtag5192.html').scale(0.6)
        tex19 = Text('- https://www.lernhelfer.de/schuelerlexikon/physik-abitur/').scale(0.6)
        tex19_1 = Text('hartikel/kraefte-und-ihre-messung').scale(0.6)
        tex20 = Text('- https://www.leifiphysik.de/mechanik/kraefteaddition-').scale(0.6)
        tex20_1 = Text('und-zerlegung/grundwissen/kraefteaddition').scale(0.6)
        texs = VGroup(tex1,tex2,tex2_1,tex2_2,tex3,tex4,tex5,tex6,tex6_1,tex7,tex7_1,tex8,tex8_1,tex9,tex9_1,tex10,tex10_1,
                      tex11,tex11_1,tex12,tex12_1,tex12_2,tex13,tex13_1,tex14,tex15,tex15_1,tex16,tex17,tex18,tex19,tex19_1,tex20,tex20_1)
        shift = VGroup(tex2_1,tex2_2,tex6_1,tex7_1,tex8_1,tex9_1,tex10_1,
                      tex11_1,tex12_1,tex12_2,tex13_1,tex15_1,tex19_1,tex20_1)
        texs.arrange(DOWN, aligned_edge=LEFT)
        texs.to_edge(LEFT)
        texs.to_edge(UP)
        texs.shift(LEFT*0.3)
        texs.shift(DOWN*8.5)
        shift.shift(RIGHT*0.6)
        self.add(quellengruppe)
        self.wait(1)
        self.play(quellengruppe.animate.to_corner(UL))
        self.wait(3)
        self.play(FadeIn(texs))
        self.play(texs.animate.shift(UP*7),FadeOut(quellengruppe),run_time=5.833,rate_func=linear)
        self.play(texs.animate.shift(UP*25),run_time=20.833,rate_func=linear)
        self.wait()

        specialtex1 = Tex("Link zum Scratchprojekt:").scale(1)
        specialtex2 = Tex("https://scratch.mit.edu/projects/1298259994/").scale(1)
        specialtex3 = Tex("Link zum ISS Video:").scale(1)
        specialtex4 = Tex("https://www.youtube.com/watch?v=7uaSOg4686g").scale(1)
        specialtex5 = Tex("Downloadlink zur Präsentation:").scale(1)
        specialtex6 = Tex("https://github.com/Brot-pro/Kraft").scale(1)

        self.play(FadeIn(specialtex1))
        self.wait(2)
        self.play(FadeIn(specialtex2),specialtex1.animate.shift(0.8*UP))
        self.wait()
        self.play(specialtex1.animate.to_corner(UL),specialtex2.animate.to_corner(UL).shift(0.8*DOWN))
        self.play(FadeIn(specialtex3))
        self.wait(2)
        self.play(FadeIn(specialtex4),specialtex3.animate.shift(0.8*UP))
        self.wait()
        self.play(specialtex3.animate.to_corner(DL).shift(0.8*UP),specialtex4.animate.to_corner(DL))
        self.play(FadeIn(specialtex5))
        self.wait(2)
        self.play(FadeIn(specialtex6),specialtex5.animate.shift(0.8*UP))
        self.wait(2)
        self.play(specialtex5.animate.to_edge(LEFT).shift(0.4*DOWN),specialtex6.animate.to_edge(LEFT).shift(0.4*DOWN))
        self.wait()
